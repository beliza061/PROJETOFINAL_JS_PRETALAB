...
function calcularMedia() {
  ...
  if (media === 0) {
    ...
    mensagem = (`Caramba deu ruim, você teve ${media}! Estude mais e tente novamente!`);
  } 
  else if (media <= 5.99){
    ...
    mensagem = ("Nao poderá inserir nota menor que 0 ou maior que 10");
  } 
  else {
    mensagem = ("É necessário inserir uma nota entre 0 e 10 para o calculo da média.");
  } 
